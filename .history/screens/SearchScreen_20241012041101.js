...
const styles = StyleSheet.create({
  ...
  recentSearchItem: {
    ...
    alignItems: 'center',
    margin: 10,
    backgroundColor: '#fff',  // Đảm bảo nền là trắng
    borderRadius: 10,  // Bo góc nhẹ cho các sản phẩm
    shadowColor: '#000',  // Màu của bóng
    shadowOffset: { width: 0, height: 4 },  // Vị trí của bóng
    shadowOpacity: 0.3,  // Độ trong suốt của bóng
    shadowRadius: 4,  // Độ lan rộng của bóng
    elevation: 5,  // Độ cao của bóng (dành cho Android)
  },
  recentSearchImage: {
    width: 80,
    height: 80,
