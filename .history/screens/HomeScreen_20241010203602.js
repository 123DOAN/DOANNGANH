...
const Slider = () => {
  const images = [
    { id: '1', source: require('../assets/Slider1.png'), title: 'Goldie is an unexpected concept proudly created by Vietnamese people.' },
    { id: '2', source: require('../assets/Slider2.png'), title: 'Redefining streetwear, igniting imagination' },
  ];
