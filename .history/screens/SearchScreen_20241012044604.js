...
const SearchScreen = () => {
  ...
  const categories = ['Jacket', 'Shirt', 'Pants', 'Shoes', 'Accessory', 'Hat'];
  ...
  return (
    <SafeAreaView style={styles.container}>
      <FlatList
        data={[{ key: 'header' }, { key: 'searchBar' }, { key: 'filter' }, { key: 'recentSearches' }]}
                ...
                <Animated.View
                  ...
                  <View style={styles.filterContent}>
                    ...
                    <Slider
                      ...
                      step={10000}
                      value={priceRange[1]} // Giá trị hiện tại của thanh trượt là giá cao nhất
                      onValueChange={(value) => setPriceRange([priceRange[0], value])} // Cập nhật giá cao nhất
                    />
                    <Text>
