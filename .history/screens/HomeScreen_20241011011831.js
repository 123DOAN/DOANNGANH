...
const styles = StyleSheet.create({
  ...
  selectedNavItem: {
    borderColor: '#FFD700', // Viền vàng cho mục được chọn
    borderWidth: 2,
    borderRadius: 10,
    backgroundColor: '#FFF8DC', // Màu nền nhạt hơn cho mục được chọn
    shadowColor: '#FFD700', // Đổ bóng màu vàng cho mục được chọn
