...
const HomeScreen = () => {
  ...
  const handleSelectCategory = (category) => {
    ...
    setSliderVisible(false); // Đóng slider khi chọn xong
    console.log('Selected Category:', category.name); // In ra category đã chọn
  };
...
const styles = StyleSheet.create({
  ...
  slideContainer: {
    ...
    left: 0,
    bottom: 0,
    width: 300, // Độ rộng của trang trượt
    backgroundColor: '#fff',
    elevation: 5,
    padding: 20,
    zIndex: 999, // Đặt zIndex cao hơn để nằm trên cùng
  },
  closeButton: {
    alignSelf: 'flex-end',
    padding: 10,
  ...
  categoryItem: {
    paddingVertical: 15,  // Thêm khoảng cách giữa các mục
    paddingHorizontal: 20,  // Căn chỉnh phần nội dung text
    borderBottomWidth: 1,  // Đường kẻ dưới mỗi mục
    borderBottomColor: '#E0E0E0',  // Màu của đường kẻ
  },
  categoryText: {
