...
import Slider from '@react-native-community/slider'; // Import Slider nếu cần

// Slider component
const SliderComponent = ({ visible }) => {
  const images = [
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <TouchableOpacity
          ...
          onPress={() => setSliderVisible(!sliderVisible)} // Chuyển đổi hiển thị thanh trượt
        >
      ...
      <ScrollView>
        {/* Slider */}
        <SliderComponent visible={sliderVisible} />
