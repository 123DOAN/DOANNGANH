...
const filterProducts = (category) => {
  if (category.name === 'All') {
    return [...initialProducts, ...additionalProducts]; // Hiển thị tất cả sản phẩm
  }
  // Ở đây bạn cần thêm thuộc tính category vào các sản phẩm của bạn
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={styles.productItem}>
              <Image
              source={item.image ? item.image : require('../assets/images/apple_icon.png')}  // Use a fallback image if image is null
