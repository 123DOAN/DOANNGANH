...
export default function AddressesScreen() {
  const [selectedIndex, setSelectedIndex] = useState(0); // Mặc định chọn địa chỉ đầu tiênconst [selectedIndex, setSelectedIndex] = useState(0); // Mặc định chọn địa chỉ đầu tiên
