...
const styles = StyleSheet.create({
  ...
  categoryButton: {
    paddingVertical: 10, // Thay vì đặt padding cố định cho tất cả các hướng
    paddingHorizontal: 15, // Padding ngang sẽ giúp nút giãn theo nội dung
    borderWidth: 1,
    borderColor: '#ccc',
    borderRadius: 15,
    marginVertical: 5,
    alignSelf: 'flex-start', // Cho phép nút tự động mở rộng theo nội dung
  },
  selectedCategory: {
