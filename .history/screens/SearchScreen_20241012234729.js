...
const SearchScreen = () => {
  ...
  <Slider
    ...
    minimumValue={0} // Giá trị nhỏ nhất là 0đ
    maximumValue={5000000} // Giá trị lớn nhất là 5 triệu đồng
    step={10000} // Bước tăng/giảm là 10.000đ
    value={price} // Giá trị hiện tại
    onValueChange={(value) => setPrice(value)} // Cập nhật giá trị khi kéo
    minimumTrackTintColor="#4CAF50" // Màu phần đã kéo
    maximumTrackTintColor="#d3d3d3" // Màu phần chưa kéo
    thumbTintColor="#4CAF50" // Màu của nút kéo
  />

  {/* Hiển thị mức giá 0đ và 5 triệu dưới thanh trượt */}
  <View style={styles.priceLabelContainer}>
    <Text style={styles.priceLabel}>0đ</Text>
    <Text style={styles.priceLabel}>5 triệu</Text>
  </View>
</View>
...
const styles = StyleSheet.create({
  ...
  priceLabelContainer: {
    ...
    paddingHorizontal: 5,
    marginTop: 5, // Giảm khoảng cách giữa thanh trượt và nhãn giá
  },
  priceLabel: {
    fontSize: 14,
    color: 'gray',
    paddingVertical: 0, // Bỏ padding dọc để nhãn sát thanh trượt hơn
  },
  buttonContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between',
