...
const styles = StyleSheet.create({
  ...
  logo: {
    width: 120, // Điều chỉnh kích thước logo cho giống ảnh
    height: 30,
    resizeMode: 'contain',
  },
  iconButton: {
  ...
  icon: {
    width: 24, // Kích thước icon nhỏ hơn
    height: 24,
  },
  slider: {
    height: 250, // Chiều cao của slider để giống ảnh
    borderRadius: 0, // Đảm bảo hình ảnh không có góc bo tròn
  },
  filterTitle: {
    fontSize: 20,
    fontWeight: 'bold',
  ...
  productItem: {
    ...
    padding: 10, // Giảm padding để ô sản phẩm không quá lớn
    alignItems: 'center',
    justifyContent: 'center',
  },
  productImage: {
    width: '100%',
    height: 120, // Điều chỉnh chiều cao ảnh sản phẩm
  ...
  price: {
    ...
    color: '#888',
    textAlign: 'center',
    textDecorationLine: 'line-through', // Thêm gạch ngang cho giá ban đầu
  },
  discountPrice: {
    fontSize: 14,
    color: '#000', // Màu giá giảm là màu đen
    textAlign: 'center',
  },
  discountTag: {
    position: 'absolute',
    top: 5,
    right: 5,
    backgroundColor: '#ff0000', // Màu đỏ cho tag giảm giá
    paddingHorizontal: 6,
    paddingVertical: 2,
    borderRadius: 4,
    color: '#fff',
