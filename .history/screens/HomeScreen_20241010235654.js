...
const HomeScreen = () => {
  ...
  const additionalProducts = [
    { id: '5', name: 'NEW ARRIVAL SHIRT', originalPrice: '700,000₫', discountedPrice: '630,000₫', discountPercent: 10, image: require('../assets/images/newarrivalshirt.jpg') },
    { id: '6', name: 'CASUAL SHORTS', discountedPrice: '850,000₫', image: require('../assets/images/casualshorts.jpg') },
    { id: '7', name: 'DENIM JACKET', originalPrice: '1,200,000₫', discountedPrice: '1,080,000₫', discountPercent: 10, image: require('../assets/images/denimjacket.jpg') },
    { id: '8', name: 'CHINO PANTS', originalPrice: '1,500,000₫', discountedPrice: '1,350,000₫', discountPercent: 10, image: require('../assets/images/chinopants.jpg') },
  ];
        ...
        <FlatList
          ...
          ListFooterComponent={
            <TouchableOpacity style={styles.moreButton} onPress={loadMoreProducts}>
              <Text style={styles.moreButtonText}>More Products</Text>
            </TouchableOpacity>
          }
        />
      </ScrollView>
