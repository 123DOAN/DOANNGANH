...
const styles = StyleSheet.create({
  ...
  productImage: {
    width: '100%', // Để hình ảnh lấp đầy toàn bộ ô
    height: 100,
    borderRadius: 8, // Bo tròn các góc của hình ảnh
    marginBottom: 8,
    overflow: 'hidden', // Đảm bảo không có phần nào của hình ảnh vượt ra ngoài ô
  },
  image: {
    width: '100%', // Để hình ảnh lấp đầy
    height: '100%', // Đảm bảo hình ảnh chiếm toàn bộ không gian
    resizeMode: 'cover', // Cắt hình ảnh nếu cần
  },
  productName: {
    fontSize: 16,
    fontWeight: 'bold',
