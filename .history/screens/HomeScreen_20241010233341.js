  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        columnWrapperStyle={styles.columnWrapper} // Căn chỉnh các sản phẩm theo hàng
      />
...
const styles = StyleSheet.create({
  ...
  topBar: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between', // Căn giữa logo và các icon
  ...
  productItem: {
    ...
    width: '45%', // Điều chỉnh để phù hợp với lưới 2 cột
  ...
  columnWrapper: {
    ...
    marginHorizontal: 10, // Khoảng cách lề giữa các cột
  },
  bottomNav: {
    flexDirection: 'row',
