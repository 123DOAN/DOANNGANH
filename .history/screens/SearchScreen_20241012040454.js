...
const SearchScreen = () => {
  ...
  const recentSearches = [
    ...
    { id: '2', name: 'BROWN WASHED MESH MIX WINDBREAKER JACKET', image: require('../assets/images/palmtree.png../assets/images/windbreaker.jpg') },
    { id: '3', name: 'MULTI BUCKLE WASHED GREY DENIM PANTS', image: require('../assets/images/greydenim.jpg') },
    { id: '4', name: 'GOTM WASHED KNIT SWEATER', image: require('../assets/images/knitsweater.jpg') },
  ];
